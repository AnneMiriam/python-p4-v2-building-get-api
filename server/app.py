...
def games():
    ...
    response = make_response(
        ...
        # *OR
        # *jsonify serializes its arguments as JSON and returns a Response object
        # *it can accept lists and dictionaries as arguments NOT models
        # jsonify(games),
        # 200
    )
    return response
